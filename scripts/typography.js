...
// Include CSS file to support generated elements
...
// BUILD the report UI units for each type element tagged with the class 'report'. Run once on load.
...
function reportType() { 
  myElements = document.querySelectorAll(".report");
  ...
  myElements.forEach(function(myElement, index) {
    ...
    //console.log("myElement: "+myReports[2]);  
